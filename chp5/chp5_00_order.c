...
int main(void){
    ...
    start[2]->leftChild = NULL;
    start[2]->data = 'E';
    start[2]->rightChild = NULL;
    start[3]->leftChild = start[5];
    start[3]->data = '*';
    start[3]->rightChild = start[6];
    start[4]->leftChild = NULL;
    start[4]->data = 'D';
    start[4]->rightChild = NULL;
    start[5]->leftChild = start[7];
    start[5]->data = '/';
    start[5]->rightChild = start[8];
    start[6]->leftChild = NULL;
    start[6]->data = 'C';
    start[6]->rightChild = NULL;
    start[7]->leftChild = NULL;
    start[7]->data = 'A';
    start[7]->rightChild = NULL;
    start[8]->leftChild = NULL;
    start[8]->data = 'B';
    start[8]->rightChild = NULL;};
    ...
    // start[3]->leftChild = NULL;
    // start[3]->data = 'A';
    // start[3]->rightChild = NULL;
    // start[4]->leftChild = NULL;
    // start[4]->data = 'B';
    // start[4]->rightChild = NULL;
    // start[5]->leftChild = start[7];
