...
int main(void){
    ...
    start1[2]->leftChild = NULL;
    start1[2]->data = 'E';
    start1[2]->rightChild = NULL;
    start1[3]->leftChild = start1[5];
    start1[3]->data = '*';
    start1[3]->rightChild = start1[6];
    start1[4]->leftChild = NULL;
    start1[4]->data = 'D';
    start1[4]->rightChild = NULL;
    start1[5]->leftChild = start1[7];
    start1[5]->data = '/';
    start1[5]->rightChild = start1[8];
    start1[6]->leftChild = NULL;
    start1[6]->data = 'C';
    start1[6]->rightChild = NULL;
    start1[7]->leftChild = NULL;
    start1[7]->data = 'A';
    start1[7]->rightChild = NULL;
    start1[8]->leftChild = NULL;
    start1[8]->data = 'B';
    start1[8]->rightChild = NULL;};
    ...
    start2[3]->leftChild = NULL;
    start2[3]->data = 'A';
    start2[3]->rightChild = NULL;
    start2[4]->leftChild = NULL;
    start2[4]->data = 'B';
    start2[4]->rightChild = NULL;
    start2[5]->leftChild = start2[7];
    start2[5]->data = '*';
    start2[5]->rightChild = start2[8];
    start2[6]->leftChild = NULL;
    start2[6]->data = 'E';
    start2[6]->rightChild = NULL;
    start2[7]->leftChild = NULL;
    start2[7]->data = 'C';
    start2[7]->rightChild = NULL;
    start2[8]->leftChild = NULL;
    start2[8]->data = 'D';
    start2[8]->rightChild = NULL;};
